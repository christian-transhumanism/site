...
The Age of the Earth is verified, or "seen" from scientific insights. Common misrepresentations of Faith, which are not faith at all, must be refuted by the church:
...
The 'faith' that atheists feel (that God doesn't exist and the universe mindlessly self-created) is no different (in epistemology) to Christian faith. It is the same feeling of certainty of what cannot be verified.
...
We lack total knowledge of the Creation. How do we deal with this 'epistemic gap'? A rigorous definition of faith needs an epistemic framework. Scripture includes the concept of fallibilism, the concept that we can never be exactly sure of what is right.

"_Now I know in part; then I shall know fully, even as I am fully known."_ 1 Cor 13:9

"_Those who say they know something do not yet know as they ought"_ 1 Cor 8:2

"_Recognition of fallibility is a prerequisite to a community of mutual agency and correction_." – Micah Redding

All observations are theory laden (Popper) that is, we never see events without a pre-existing framework of understanding. The secular parable of the blind men and the elephant provides valuable insight, and corresponds with the Body Metaphor in Christianity, that all parts of the Body of Christ have different roles and insights.

Because knowledge progresses not by observation, but by conjecture and critique, it is important to hear all voices. Good-faith free speech is a necessary but insufficient condition for what we really want, which is great quality learning dialogue.
...
Creating powerful explanatory knowledge, and testing what really are the best choices for the future requires a better epistemological framework ("Theory of Knowledge").

Therefore, the CTA is developing the New Matrix Epistemology. This defines domains of knowledge, and truth-seeking processes. These interact in a Matrix.
...
Faith is an optimistic commitment to a vision. Faith is confident that God exists, from both the General and Special Revelations.
